...
<body>
	...
	<div class="container-fluid">
		...
		<div class="container">
			...
			<div class="col-md-23">
				...
				<form accept-charset="UTF-8" action="listaExamen"
								...
								<table id="tableAlumno"
									...
									<thead>
										<tr>
											...
											<th>Nombre</th>
											<th>Descripcion</th>
											<th>Cantantidad de Preguntas.</th>
											<th>Puntaje Aprobatorio</th>
											<th>Porcentaje Aprobatorio</th>
											<th>Valor Total</th>
											<th>Duracion</th>
											<th>Estado</th>
											<th>Actualiza</th>
											...
											<tr>
												...
												<td>
													<button type='button' data-toggle='modal'
														onclick="editar('${x.idexamen}','${x.nombre}','${x.descripcion}','${x.claves}','${x.numPreguntas}','${x.valorAprobatorio}','${x.porAprobacion}','${x.valorTotal}','${x.duracion}','${x.estado}');"
									...
									<div class="panel panel-default">
										...
										<div id="stepOne" class="panel-collapse collapse in">
											<div class="panel-body">
												...
												<div class="form-group">
													<label class="col-lg-3 control-label" for="id_act_duracion">Duracion</label>
													<div class="col-lg-5">
												...
												<div class="form-group">
													...
													<select id="id_reg_estado" name="estado" style="width: 300px"
														class='form-control'>
									...
									<div class="panel panel-default">
										...
										<div id="stepOne" class="panel-collapse collapse in">
											<div class="panel-body">
												...
												<div class="form-group">
													<label class="col-lg-3 control-label" for="id_act_estado">Estado</label>
													<select id="id_act_estado" name="estado" style="width: 300px"
														class='form-control'>
														<option value=" ">Seleccione</option>
														<option value="Activo">Activo</option>
														<option value="Inactivo">Inactivo</option>
	...
	<script type="text/javascript">
		...
		function editar(idexamen, nombre, descripcion, claves, numPreguntas,
				valorAprobatorio, porAprobacion, valorTotal, duracion, estado) {
