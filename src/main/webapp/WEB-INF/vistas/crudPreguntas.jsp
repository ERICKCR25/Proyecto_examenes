...
<br>&nbsp;<br>
										...
										<tr>
											...
											<td>
												<button type='button' data-toggle='modal'
													onclick="editar('${x.idPregunta}','${x.nPregunta}','${x.enunciado}','${x.materia.idMateria}');"
									...
									<div id="stepOne" class="panel-collapse collapse in">
										<div class="panel-body">
											...
											<div class="form-group">
												...
												<div class="col-lg-5">
													<div class="col-lg-5">
													<select class="form-control" id="id_reg_idMateria" name="materia.idMateria" >
									...
									<div id="stepOne" class="panel-collapse collapse in">
										<div class="panel-body">
											...
											<div class="form-group">
												...
												<div class="col-lg-5">
													<select class="form-control" id="id_act_idMateria" name="materia.idMateria">
														<option>Seleccione</option>
													</select>
												</div>
											</div>
	...
	$(document).ready(function() {	
		$.getJSON("cargaMateria",{}, function (data){
			$.each(data, function(index, item){
				$('#id_reg_idMateria').append("<option value='" +item.idMateria + "'>" + item.nombre + "</option>" );          
				$('#id_act_idMateria').append("<option value='" +item.idMateria + "'>" + item.nombre + "</option>" );              
			});
		});
	...
	<script type="text/javascript">
		...
		function editar(id, nPregunta, enunciado, idMateria ) {
			...
			$('select[id=id_act_idMateria]').val(idMateria);
